...
SESSION_START();
//create a predefined username and password since we do not have database
$acc_username = "Mhelliscent";
$acc_password = "mhelliscent1222";
$acc_fullname = "Mhelliscent Ollado";
$acc_address = "Balogo, Boac, Marinduque, Philippines";
...
if(isset($_REQUEST['login_button']) == true){
	...
	//tama ang username and password
	else if($_REQUEST['form_username']==$acc_username && $_REQUEST['form_password'] == $acc_password){
